"""Test-time stubs for Home Assistant modules used by the integration."""
...
def ensure_homeassistant_stubs() -> None:
    ...
    if "homeassistant.const" not in sys.modules:
        ...
        class Platform(Enum):  # pragma: no cover - minimal enum for tests
            SENSOR = "sensor"
    ...
    if "homeassistant.helpers.entity_registry" not in sys.modules:
        ...
        async def async_migrate_entries(*_args: Any, **_kwargs: Any) -> None:
            return None
    ...
    if "homeassistant.helpers.update_coordinator" not in sys.modules:
        coordinator_stub = types.ModuleType(
